...
var backgroundImg;
var bg1;
var good,Super,congrats,excellent;
var goodImg,superImg,congratsImg,excellentImg;
...
function preload(){
    ...
    excellentImg = loadImage("images/excellent.png");
    superImg = loadImage("images/super.png");
...
function setup(){
    ...
    good = createSprite(0,150);
    good.addImage(goodImg);
    good.visible=false;
    good.scale=0.7;

    Super = createSprite(0,150);
    Super.addImage(superImg);
    Super.visible=false;
    Super.scale=0.7;

    excellent = createSprite(0,150);
    excellent.addImage(excellentImg);
    excellent.visible=false;
    excellent.scale=0.7;

    congrats = createSprite(0,150);
...
if(gameState === PLAY){
        ...
        if(score === 75){
            ...
            excellent.velocityX=3;
        }

        if(score === 100){
            congrats.visible=true;
            congrats.velocityX=3;
        }
